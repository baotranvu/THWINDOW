...
namespace QLST {
    ...
    public partial class invoice : global::System.Data.DataSet {
        ...
        public partial class InvoicesDataTable : global::System.Data.TypedTableBase<InvoicesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public InvoicesRow AddInvoicesRow(string InvID, string CusID, string EmpID, System.DateTime Date) {
        ...
        public partial class InvoicesRow : global::System.Data.DataRow {
            ...
            public string CusID {
                get {
                    return ((string)(this[this.tableInvoices.CusIDColumn]));
                }
                set {
                    this[this.tableInvoices.CusIDColumn] = value;
                }
            }
...
namespace QLST.invoiceTableAdapters {
    ...
    public partial class InvoicesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Invoices] WHERE (([InvID] = @Original_InvID) AND ([CusID] = @O" +
                "riginal_CusID) AND ([EmpID] = @Original_EmpID) AND ([Date] = @Original_Date))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Invoices] ([InvID], [CusID], [EmpID], [Date]) VALUES (@InvID, " +
                "@CusID, @EmpID, @Date);\r\nSELECT InvID, CusID, EmpID, Date FROM Invoices WHERE (I" +
                "nvID = @InvID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Invoices] SET [InvID] = @InvID, [CusID] = @CusID, [EmpID] = @EmpID, [Date] = @Date WHERE (([InvID] = @Original_InvID) AND ([CusID] = @Original_CusID) AND ([EmpID] = @Original_EmpID) AND ([Date] = @Original_Date));
SELECT InvID, CusID, EmpID, Date FROM Invoices WHERE (InvID = @InvID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT InvID, CusID, EmpID, Date FROM dbo.Invoices";
        ...
        public virtual int Fill(invoice.InvoicesDataTable dataTable) {
        ...
        public virtual invoice.InvoicesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            invoice.InvoicesDataTable dataTable = new invoice.InvoicesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(invoice.InvoicesDataTable dataTable) {
        ...
        public virtual int Delete(string Original_InvID, string Original_CusID, string Original_EmpID, System.DateTime Original_Date) {
        ...
        public virtual int Insert(string InvID, string CusID, string EmpID, System.DateTime Date) {
            if ((InvID == null)) {
        ...
        public virtual int Update(string InvID, string CusID, string EmpID, System.DateTime Date, string Original_InvID, string Original_CusID, string Original_EmpID, System.DateTime Original_Date) {
            if ((InvID == null)) {
                throw new global::System.ArgumentNullException("InvID");
            }
            else {
            ...
            if ((Original_InvID == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(Original_InvID));
            }
            if ((Original_CusID == null)) {
                throw new global::System.ArgumentNullException("Original_CusID");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CusID, string EmpID, System.DateTime Date, string Original_InvID, string Original_CusID, string Original_EmpID, System.DateTime Original_Date) {
            return this.Update(Original_InvID, CusID, EmpID, Date, Original_InvID, Original_CusID, Original_EmpID, Original_Date);
        }
    }
