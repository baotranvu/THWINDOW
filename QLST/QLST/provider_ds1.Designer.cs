...
namespace QLST {
    ...
    public partial class provider_ds : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/provider_ds1.xsd";
        ...
        public partial class ProvidersDataTable : global::System.Data.TypedTableBase<ProvidersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProvidersRow AddProvidersRow(string ProID, string Name) {
...
namespace QLST.provider_dsTableAdapters {
    ...
    public partial class ProvidersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Providers] WHERE (([ProID] = @Original_ProID) AND ([Name] = @O" +
                "riginal_Name))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Providers] SET [ProID] = @ProID, [Name] = @Name WHERE (([ProID] = @" +
                "Original_ProID) AND ([Name] = @Original_Name));\r\nSELECT ProID, Name FROM Provide" +
                "rs WHERE (ProID = @ProID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProID, Name FROM dbo.Providers";
        ...
        public virtual int Delete(string Original_ProID, string Original_Name) {
            if ((Original_ProID == null)) {
                throw new global::System.ArgumentNullException("Original_ProID");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[0].Value = ((string)(Original_ProID));
            }
        ...
        public virtual int Update(string ProID, string Name, string Original_ProID, string Original_Name) {
            if ((ProID == null)) {
            ...
            if ((Original_ProID == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Original_ProID));
            }
            if ((Original_Name == null)) {
                throw new global::System.ArgumentNullException("Original_Name");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Original_ProID, string Original_Name) {
            return this.Update(Original_ProID, Name, Original_ProID, Original_Name);
        }
    }
